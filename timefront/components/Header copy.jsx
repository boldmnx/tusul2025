...
//           </div>
//           <h1 className="text-2xl font-black bg-gradient-to-r from-indigo-600 to-blue-500 bg-clip-text text-transparent tracking-tighter"></h1>
//         </Link>
...
//         {/* Баруун талын товчлуур (Жишээ нь: Нэвтрэх эсвэл Профайл) */}
//         <div className="flex items-center gap-4">
//           <button className="hidden sm:block text-sm font-semibold text-slate-600 hover:text-indigo-600 transition">
//             Тусламж
//           </button>
//           <div className="w-10 h-10 rounded-full bg-indigo-50 border-2 border-indigo-100 flex items-center justify-center text-indigo-600 font-bold cursor-pointer hover:bg-indigo-100 transition">
//             U
//           </div>
//         </div>
//       </div>
